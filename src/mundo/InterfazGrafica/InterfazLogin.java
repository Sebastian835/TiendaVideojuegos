...
public class InterfazLogin extends JFrame {
	...
	public InterfazLogin() {
		...
		lblNewLabel.setIcon(new ImageIcon("Imagenes\\logoGeneral.jpg"));
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setBounds(22, 114, 293, 319);
		...
		lblNewLabel_1.setBounds(50, 38, 233, 70);
		...
		contrasena.setFont(new Font("Dialog", Font.PLAIN, 18));
		contrasena.setBounds(81, 267, 236, 41);
		...
		btnNewButton.setBounds(45, 385, 133, 29);
		...
		btnNewButton_1.setBounds(220, 385, 133, 29);
		...
		textUsu.setFont(new Font("Dialog", Font.PLAIN, 18));
		textUsu.setBounds(81, 176, 236, 42);
		panel_1.add(textUsu);
