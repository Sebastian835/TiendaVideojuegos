...
public class VentanaJuegosGeneral extends JFrame {
	...
	public VentanaJuegosGeneral() {
		...
		btnEliminarJuego.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(comboBoxJuegos.getSelectedItem() == null){
					JOptionPane.showMessageDialog(null, "No hay un juegos en la tienda", "ERROR", JOptionPane.ERROR_MESSAGE);
				}else{
		...
		lblNewLabel_5.setBounds(386, 141, 434, 236);
		...
		JLabel lblNewLabel_6 = new JLabel("Buscar Juego por Nombre");
		lblNewLabel_6.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblNewLabel_6.setBounds(454, 10, 291, 30);
		panel_1.add(lblNewLabel_6);
		
		textFieldBuscar = new JTextField();
		textFieldBuscar.setFont(new Font("Tahoma", Font.PLAIN, 19));
		textFieldBuscar.setBounds(464, 51, 238, 30);
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (comboBoxJuegos.getSelectedItem() == null) {
					JOptionPane.showMessageDialog(null, "No hay juegos en la biblioteca", "ERROR", JOptionPane.ERROR_MESSAGE);
				}else if (textFieldBuscar.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Escribe el nombre del juego", "ERROR", JOptionPane.ERROR_MESSAGE);
				}else {
					Juegos nuevo = VentanaRegistrarJuego.tiendita.buscarNombre(textFieldBuscar.getText());
					textFieldCodigo.setText(Integer.toString(nuevo.getCodigo())); 
					textFieldGenero.setText(nuevo.getGenero().toString());
					textFieldPrecio.setText(String.valueOf(nuevo.getCosto()));
					textFieldKey.setText(Integer.toString(nuevo.getCantidadActual()));
				}
			}
		});
		btnBuscar.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnBuscar.setBounds(543, 95, 85, 21);
